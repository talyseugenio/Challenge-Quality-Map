Este projeto é um exemplo de automação de teste usando Playwright, uma biblioteca Node.js que oferece uma API de alto nível para automação de navegadores.
